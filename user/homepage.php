  ...
  <body>
    <?php
	  ...
	  $user = mysqli_fetch_array($query);
		echo "<br><font size = 4 align = 'left'> &nbsp Benvenuto, &nbsp" . $user['name'] . "!";
	  ?>
	<div class = 'home_user'>
	  <h3 align = 'center-left' style = 'color: red'> Cosa puoi fare su questo sito? </h3>
	  <font size = 4> E' una piattaforma a disposizione degli studenti mediante i quali, dopo essersi registrati, <br> sar&agrave
          possibile visualizzare e/o prenotare libro scelto tra una vasta gamma di libri <br> messi a disposizione della biblioteca scolastica dell' 
